...
export const BookItem = ({ book }: BookItemProps) => {
  ...
  return (
    <article
      className="book-item group flex flex-col gap-3 p-3 rounded-xl border border-border-custom bg-card/50 backdrop-blur-md hover:bg-card hover:shadow-md transition-all duration-300 h-full"
      data-book-id={id}
    >
